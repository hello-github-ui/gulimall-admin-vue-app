    ...
    <div class="mod-schedule">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button v-if="isAuth('sys:schedule:save')" type="primary" @click="addOrUpdateHandle()">新增
                </el-button>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    ...
                    <el-button v-if="isAuth('sys:schedule:pause')" size="small" type="text"
                    ...
                    <el-button v-if="isAuth('sys:schedule:run')" size="small" type="text"
